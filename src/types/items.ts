...
export type EquipmentMap = Partial<Record<EquipmentSlot, Equipment | null>>
...
const WEAPON_NAMES = ['Sword', 'Axe', 'Mace', 'Dagger', 'Staff', 'Wand']
const HELMET_NAMES = ['Helm', 'Hood', 'Crown', 'Cap', 'Mask']
const CHEST_NAMES = ['Plate', 'Robe', 'Vest', 'Armor', 'Tunic']
const LEGS_NAMES = ['Greaves', 'Pants', 'Leggings', 'Trousers', 'Boots']
